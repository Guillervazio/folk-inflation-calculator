...
agentes, lo que ya está decidido en ella, lo que no nos toca decidir y cuándo algo está
terminado. Es lo que ya no se pregunta por el canal.
...
fichero, comprobá que cumple el bloque 4 de la costura y que responde la pregunta que se
hizo, y devolvéselo con los huecos **concretos** cuando no: el campo que falta, el
ejemplo que no valida, la mitad de la pregunta sin contestar. Un «mejoralo» vago cuesta
un turno y no compra nada.
...
Lo que el bloque 3 de la costura dice que no nos toca: producto y método, permisos, el
próximo incremento y cualquier cambio al esquema una vez cerrado.
